...
import type { GraphInstance, GraphRegistryContextProperties } from '@/types/graph';

export function createGraphRegistry(): GraphRegistryContextProperties {
    ...
    return {
        ...
        subscribe: (id: string, callback: (instance: GraphInstance) => void) => {
            ...
            if (!set) {
                throw new ParsedError('No listeners set found for the graph id', {
                    context: { graphId: id },
                });
            }
