                                ...
                                <div className="flex justify-center mt-2 rounded-xl border-2 border-dashed border-base-300 px-6 py-5">
                                    <div className="text-center text-sm">
                                        ...
                                        <div className="mt-4 flex items-center justify-center">
                                            <label
                                                className="flex rounded-md font-medium text-accent cursor-pointer focus-within:outline-none focus-within:ring-5 hover:text-accent/80"
                                                htmlFor="file-upload"
                                            >
                                            ...
                                            <p className="pl-1 text-base-content/80">
                                                or drag and drop
                                            </p>
                                        </div>
                            ...
                            <div>
                                ...
                                <div className="mt-2 w-full rounded-lg bg-base-200 p-4 h-32 flex items-center justify-center">
                                    <p className="text-sm text-base-content/60">
                                        No data to preview. Please select a file
                                        to import.
                                    </p>
                                </div>
                            </div>
