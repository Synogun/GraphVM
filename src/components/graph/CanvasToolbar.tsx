...
export function CanvasToolbar() {
    ...
    return (
        <div className="absolute bottom-4 left-4 z-20 hidden lg:flex items-center bg-base-200 rounded-lg border border-base-300 shadow-xl/45 p-1 gap-0.5 select-none">
